...
## d) 
Simule dados de um novo tipo celular (digamos TSim) em que há efeito de interação entre Tratamento  e  exposição  ao  Virus. Proponha  uma  análise*  dos  dados  gerados.
